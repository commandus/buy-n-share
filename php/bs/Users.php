...
class Users extends Table
{
     ...
     * @return Users
     */
    public static function getRootAsUsers(ByteBuffer $bb)
    {
        $obj = new Users();
     ...
     * @return void
     */
    public static function startUsers(FlatBufferBuilder $builder)
    {
     ...
     * @return Users
     */
    public static function createUsers(FlatBufferBuilder $builder, $users)
    {
        $builder->startObject(1);
     ...
     */
    public static function endUsers(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
